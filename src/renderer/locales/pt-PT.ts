...
export const ptPT = {
  ...
  'preview.empty.title': 'Ainda nao ha nada para previsualizar',
  'preview.empty.description': 'Adicione ficheiros ou pastas e depois empilhe regras de renomeacao para ver um diff antes/depois aqui.',
  ...
  'rules.empty.title': 'Construa a sua pilha de regras',
  'rules.empty.description': 'Adicione uma regra para transformar nomes de cima para baixo. Comece com Novo Nome ou Localizar / Substituir.',
