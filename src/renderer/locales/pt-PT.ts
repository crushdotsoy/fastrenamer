...
export const ptPT = {
  ...
  'updates.summary.up_to_date_manual': 'Esta instalacao corresponde a ultima release publicada. Atualizacoes futuras no macOS vao abrir o GitHub para download manual.',
  ...
  'updates.summary.idle_manual': 'Esta build macOS verifica atualizacoes, mas a instalacao tem de ser descarregada manualmente no GitHub Releases.',
