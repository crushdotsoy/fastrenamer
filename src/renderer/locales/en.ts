...
export const en = {
  ...
  'preview.empty.description': 'Add files or folders, then stack rename rules to see a live before/after diff here.',
  ...
  'rules.empty.title': 'Build your rename stack',
  'rules.empty.description': 'Add a rule to transform names top to bottom. Start with New Name or Find / Replace.',
