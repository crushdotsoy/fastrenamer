...
export const en = {
  ...
  'updates.summary.up_to_date_manual': 'This installation matches the latest published release. Future macOS updates will open GitHub for a manual download.',
  ...
  'updates.summary.idle_manual': 'This macOS build checks for updates, but installs must be downloaded manually from GitHub Releases.',
