...
export const en = {
  ...
  'appearance.copy_help': 'Duplicate this theme to create an editable custom palette',
  'appearance.swatch.background': 'Background color',
  'appearance.swatch.card': 'Card color',
  'appearance.swatch.surface': 'Surface color',
  'appearance.swatch.accent': 'Accent color',
  'appearance.swatch.destructive': 'Destructive color',
